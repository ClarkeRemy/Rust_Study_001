...
mod js {
	...
	extern "C" {
		...
		pub fn bufferDataF32(target: GLenum, data_ptr: *const f32, data_length: usize, usage: GLenum);
		pub fn bufferDataU16(target: GLenum, data_ptr: *const u16, data_length: usize, usage: GLenum);
		...
		pub fn getAttribLocation(program: JSObject, name: *const u8, source_lengt: usize) -> GLuint;
